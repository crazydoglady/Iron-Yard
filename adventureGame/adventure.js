...
var beach = function() {
  ...
  console.log("You decide to leave it and turn back to the humans. You saw your humans bring home a steak from the store. Maybe they will share later.")
  waves();
} else if (beachPrompt ==="eat") {
  alert("Nom Nom. Jellyfish ary spicy...and tingly. Humans are upset and suddenly rush you back to the car.")
  console.log("Nom Nom. Jellyfish ary spicy...and tingly. Humans are upset and suddenly rush you back to the car.");
  vet();
}
};
...
if (wavePrompt === "swim") {
  ...
  console.log("The waves are a little too scary today. Humans will protect you and you continue your walk.")
  bird();
}
};
...
if(birdPrompt === "chase") {
  alert("You take chase at full speed, blindly following the bird into the waves.");
  console.log("You take off and reach top speed within a few strides, ripping the leash from the humans. Your target, the little bird panics and flutters into the water. Instinct takes over and you follow blindly into the ocean.")
  outToSea();
} else if (birdPrompt === "ignore") {
  alert("You remember that you are retired. You have the Humans to bring you food now. You wistfully remember your racing glory and a tear falls into the sand.")
  console.log("You remember that you are retired. You have the Humans to bring you food now. You wistfully remember your racing glory and a tear falls into the sand.")
  tourist();
}
};
...
console.log("You barely get a carrot before the humans take away your snack and force you to keep walking. You approach the dunes at the end of the beach and are secretly relieved that the walk seems to be ending.")
  ...
  alert("Nom Nom. Now you know why humans sneak chocolate into the house and are secretly resentful that they never share with you. Humans suddenly start yelling and dragging you back towards the car. You pull the other way, wanting to continue your walk.")
  console.log("Nom Nom. Now you know why humans sneak chocolate into the house and are secretly resentful that they never share with you. Humans suddenly start yelling and dragging you back towards the car. You pull the other way, wanting to continue your walk.")
  vet()
}
};
...
var ember =function() {
  ...
  var ride = prompt( "It is a Saturday morning and your humans are home.They look at you and ask, 'Would you like to go in the car?'Do you want to go with the humans: YES or NO?") .toLowerCase();
  if (ride === "yes") {
...
confirm("Welcome! Are you ready to begin?");
